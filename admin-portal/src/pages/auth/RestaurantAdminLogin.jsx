...
const RestaurantAdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (matched) {
      const result = await login({ role: ROLES.RESTAURANT_ADMIN });
      if (result.success) {
      ...
      setError('Invalid email or password for Restaurant Admin');
      setIsSubmitting(false);
    }
  };
    ...
    <div className="admin-login-page">
      <div className="admin-login-card">
        ...
        <div className="admin-brand-section">
          ...
          <p className="admin-muted-text">Enter your credentials to access the restaurant admin portal</p>
        </div>
        ...
        {/* <div className="admin-demo-credentials">
          ...
          <p>Email: restaurant@admin.com</p>
